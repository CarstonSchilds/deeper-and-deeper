...
const drag_friction_amount : float = 1000.0
...
func set_linear_damp(value):
	...
	water_linear_damp = value * 10.0
	air_linear_damp = value
	recalculate_drag_coefficients()
...
func set_angular_damp(value):
	...
	water_angular_damp = value * 10.0
	air_angular_damp = value
	if auto_angular_dampen:
		water_angular_damp = water_angular_damp * perpendicular_drag_ratio
		air_angular_damp = air_angular_damp * perpendicular_drag_ratio
	recalculate_drag_coefficients()
...
func recalculate_drag_coefficients():
	linear_parallel_drag_coefficient = drag_coefficient * self.linear_damp * -1
	linear_perpendicular_drag_coefficient = drag_coefficient * perpendicular_drag_ratio * self.linear_damp * -1
	linear_friction_coefficient = drag_friction_amount * drag_coefficient * self.linear_damp * -1
	
	angular_drag_coefficient = drag_coefficient * perpendicular_drag_ratio * self.angular_damp * 10.0 * -1
	angular_friction_coefficient = drag_friction_amount * drag_coefficient * self.angular_damp * 0.1 * -1
